 ...
 */
$options['shell-aliases']['localhost'] = '!drush en -y stage_file_proxy devel reroute_email maillog diff better_watchdog_ui better_watchdog_ui_rules && drush rap "anonymous user" "access devel information" && drush rap "authenticated user" "access devel information"';
